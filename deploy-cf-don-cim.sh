...
# Script de Deploy para cf.don.cim.br
# Execute este script no servidor via SSH

echo "🚀 Iniciando deploy do Sistema de Controle Financeiro..."
echo "📁 Domínio: cf.don.cim.br"
echo "📂 Diretório: /www/wwwroot/cf.don.cim.br"
echo ""
...
echo "1. Configure o Nginx: Website → cf.don.cim.br → Settings → Config File"
echo "2. Use o arquivo nginx-cf-don-cim-SEM-SSL.conf primeiro (sem SSL)"
echo "3. Configure o SSL: Website → Settings → SSL → Let's Encrypt"
echo "4. Depois use o arquivo nginx-cf-don-cim.conf (com SSL)"
echo "5. Acesse: https://cf.don.cim.br"
echo ""
