...
-- ATENÇÃO: Este script irá REMOVER todas as tabelas existentes e recriar do zero
-- Use apenas se você não tem dados importantes ou se quer começar do zero

-- 1. Remover todas as tabelas existentes (se existirem)
...
-- Verificar se todas as colunas da tabela transactions estão corretas
SELECT 
    column_name,
    data_type,
    is_nullable,
