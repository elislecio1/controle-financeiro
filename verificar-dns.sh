...
echo "🔍 Verificando configuração DNS para financeiro.donsantosba.com.br"
echo ""
...
if [ -z "$DNS_RESULT" ]; then
    ...
    echo "1. Acesse o painel DNS do seu provedor (Registro.br, Cloudflare, etc.)"
...
if [ "$DNS_OK" == true ] && [ "$HTTP_OK" == true ]; then
    ...
    echo ""
    echo "Execute:"
    echo "  sudo certbot certonly --webroot -w /www/wwwroot/financeiro.donsantosba.com.br -d financeiro.donsantosba.com.br"
