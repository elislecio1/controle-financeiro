-- Script FINAL para criar as tabelas de integrações bancárias
...
DROP INDEX IF EXISTS idx_integracoes_bancarias_banco;
DROP INDEX IF EXISTS idx_integracoes_bancarias_status;
DROP INDEX IF EXISTS idx_integracoes_bancarias_conta_id;
DROP INDEX IF EXISTS idx_integracoes_bancarias_ativo;
DROP INDEX IF EXISTS idx_logs_sincronizacao_integracao;
DROP INDEX IF EXISTS idx_logs_sincronizacao_status;
DROP INDEX IF EXISTS idx_logs_sincronizacao_created_at;
DROP INDEX IF EXISTS idx_transacoes_importadas_integracao;
DROP INDEX IF EXISTS idx_transacoes_importadas_status;
DROP INDEX IF EXISTS idx_transacoes_importadas_hash;
...
-- Verificar colunas da tabela transacoes_importadas
SELECT 
    column_name,
    data_type,
    is_nullable,
