            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="https://api.inter.com.br"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Total Importadas</p>
              <p className="text-2xl font-semibold text-gray-900">{transacoesImportadas.length}</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">
                {transacoesImportadas.filter(t => t.statusConciliacao === 'pendente').length}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">
                {transacoesImportadas.filter(t => t.statusConciliacao === 'conciliada').length}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Ignoradas</p>
              <p className="text-2xl font-semibold text-gray-900">
                {transacoesImportadas.filter(t => t.statusConciliacao === 'ignorada').length}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <select 
              ...
              onChange={(e) => {
                ...
                console.log('Filtrar por status:', e.target.value);
              }}
            >
          ...
          <div>
            ...
            <select 
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              onChange={(e) => {
                // Implementar filtro por integração
                console.log('Filtrar por integração:', e.target.value);
              }}
            >
      ...
      <div className="bg-white rounded-lg shadow-md">
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-semibold text-gray-900">
              Transações Importadas ({transacoesImportadas.length})
            </h3>
            <div className="flex space-x-2">
              <button
                onClick={() => loadData()}
        ...
        {transacoesImportadas.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Nenhuma transação importada</h3>
            <p className="text-gray-500">
              Execute uma sincronização para importar transações do banco.
            </p>
          </div>
        ) : (
          <div className="overflow-x-auto">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {transacoesImportadas.map((transacao) => (
                  <tr key={transacao.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 font-medium">{transacao.descricao}</div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                        transacao.tipo === 'credito' ? 'text-green-600 bg-green-100' :
                        transacao.tipo === 'debito' ? 'text-red-600 bg-red-100' :
                      ...
                      <div className="flex space-x-2">
                            ...
                            <button
                              onClick={async () => {
                                try {
                                  ...
                                  setMessage('Transação conciliada com sucesso!');
                                  loadData();
                                } catch (error) {
                                  console.error('Erro ao conciliar:', error);
                                  setMessage('Erro ao conciliar transação');
                                }
                              }}
                              className="text-green-600 hover:text-green-800 p-1 rounded"
                              title="Conciliar"
                            ...
                            <button
                              onClick={async () => {
                                try {
                                  ...
                                  setMessage('Transação ignorada com sucesso!');
                                  loadData();
                                } catch (error) {
                                  console.error('Erro ao ignorar:', error);
                                  setMessage('Erro ao ignorar transação');
                                }
                              }}
                              className="text-red-600 hover:text-red-800 p-1 rounded"
                              title="Ignorar"
                        ...
                        <button
                          onClick={() => {
                            ...
                            setMessage('Detalhes da transação exibidos no console');
                          }}
                          className="text-blue-600 hover:text-blue-800 p-1 rounded"
                          title="Ver detalhes"
                        >
